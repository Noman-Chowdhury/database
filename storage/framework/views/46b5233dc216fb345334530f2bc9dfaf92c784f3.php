...
<form method="POST" class="register-form" id="register-form" action="<?php echo e(route('seller.store')); ?>">
    <?php echo csrf_field(); ?>
...
<a href="<?php echo e(route('signin')); ?>" class="signup-image-link">I am already member</a>
</div>
</div>
</div>
</section>
...
<?php /**PATH C:\xampp\htdocs\project\resources\views/frontend/layouts/signup.blade.php ENDPATH**/ ?>